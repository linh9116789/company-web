      ...
      <nav class="navbar navbar-inverse navbar-fixed-top">
         <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
               ...
               <!-- <ul class="nav navbar-nav navbar-right">
                  <li><a href="<?php echo BASE_URL ?>/login/logout">Xin chào !</a></li>
               </ul> -->
            </div>
         </div>
      </nav>
         ...
         <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
               <ul class="nav nav-sidebar">
                  <li class="active"><a href="<?php echo BASE_URL ?>/login/dasboard">Tổng quan <span class="sr-only">(current)</span></a></li>
                  <li><a href="<?php echo BASE_URL ?>/category/index">Danh mục</a></li>
                  <li><a href="<?php echo BASE_URL ?>/product/index">Sản phẩm</a></li>
                  <li><a href="<?php echo BASE_URL ?>/order/index">Đơn hàng</a></li>
                  <li><a href="<?php echo BASE_URL ?>/artisan/index">Tin tức</a></li>
               </ul>
            </div>