<?php
   foreach($artisan_detailFE as $key =>$value)
   {
      $name_artisan = $value['a_name'];
            ...
            <div class="breadcrumbs">
               <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                  ...
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                     <a itemprop="item" href="<?php echo BASE_URL ?>/tintuc">
                           ...
                           <div class="grids">
                                       <div class="grids_in">
                                          ...
                                          <div class="img-right-pro">
                                             <a href="<?php echo BASE_URL ?>/sanpham/chitietsanpham/<?php echo $product['pro_id'] ?>">
                                             <img class="lazy img-pro content-image" src="<?php echo BASE_URL ?>/public/uploads/product/<?php echo $product['pro_avatar'] ?>" data-original="image/iphone.png" alt="Máy in Canon MF229DW" />
                                             </a>
                                          ...
                                          <div class="price_old_new">
                                             <div class="price">
                                                <span class="news_price"><?php echo number_format($product['pro_price'],0,',','.') ?> đ</span>
                                             </div>
                                          </div>
                                       </div>
                  </div>
