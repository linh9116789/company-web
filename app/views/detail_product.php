<?php
   ...
   {
      $name = $value['pro_name'];
      $category_name = $value['c_name'];
      $pro_description = $value['pro_description'];
      $id_category = $value['c_id'];
   }
?>
<section>
   <?php foreach($detail_product as $key =>$detailProduct) {?>
   <div class="bg_in">
         ...
         <div class="wrapper_all_main_right no-padding-left" style="width:100%;">
            <div class="breadcrumbs">
               <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                  ...
                  <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                     <a itemprop="item" href="<?php echo BASE_URL ?>/sanpham/danhmuc/<?php echo $id_category ?>">
                     <span itemprop="name"><?php echo $category_name = $value['c_name']?></span></a>
               ...
               <div class="content-right-items margin0">
                  ...
                  <div class="slider-galery ">
                     <div id="sync1" class="owl-carousel owl-theme">
                        <div class="item">
                           <img src="<?php echo BASE_URL ?>/public/uploads/product/<?php echo $value['pro_avatar'] ?>" width="100%">
                        </div>
                     </div>
                     ...
                     <div class="content-des-pro_in">
                        <div class="pro-des-sum">
                           ...
                           <div class="color_price">
                              <span class="title_price bg_green">Giá bán</span> <?php echo number_format($detailProduct['pro_price'],0,',','.') ?> <span>vnđ</span> (GIÁ CHƯA VAT)
                              <div class="clear"></div>
                           </div>
                           <!-- <div class="color_price">
                  ...
                  <div class="content-des-pro-suport">
                     <div class="box-setup">
                        ...
                        <div class="info-setup">
                           <div class="row-setup" style="font-size: 15px;">
                              <li>Màn hình: Super AMOLED Plus6.7"Full HD+</li>
                              <li>Hệ điều hành: Android 10</li>
                              <li>Camera sau: Chính 64 MP</li>
                              <li>Camera trước: 32 MP</li>
                              <li>Chip: Snapdragon 730</li>
                              <li>Ram : 8GB</li>
                              <li>Bộ nhớ trong: 128 GB</li>
                              <li>SIM: 2 Nano SIMHỗ trợ 4G</li>
                              <li>Pin, Sạc:7000 mAh25 W</li>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="grids_in">
                           <div class="content">
                              <div class="img-right-pro">
                                 <a href="<?php echo BASE_URL ?>/sanpham/chitietsanpham/<?php echo $related['pro_id'] ?>">
                                 <img class="lazy img-pro content-image" src="<?php echo BASE_URL ?>/public/uploads/product/<?php echo $related['pro_avatar'] ?>" data-original="<?php echo BASE_URL ?>/public/image/iphone.png" alt="Máy in Canon MF229DW" />
                                 </a>
                              ...
                              <div class="name-pro-right">
                                 <a href="<?php echo BASE_URL ?>/sanpham/chitietsanpham/<?php echo $related['pro_id'] ?>">
                                    <h3><?php echo $related['pro_name'] ?></h3>
                                 </a>
                              </div>
                              <div class="add_card">
                              ...
                              <div class="price_old_new">
                                 <div class="price">
                                    <span class="news_price"><?php echo number_format($related['pro_price'],0,',','.') ?> đ</span>
                                 </div>
                              </div>
                           </div>
                        </div>
